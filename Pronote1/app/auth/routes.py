...
def login():
    if request.method == "POST":
        ...
        try:
            ...
            cursor.execute("""
                SELECT u.id as user_id, u.username, u.password, p.id as prof_id, u.role
                FROM users u
            ...
            cursor.execute("""
                SELECT u.id as user_id, u.username, u.password, p.parent_id as parent_id, u.role
                FROM users u
            ...
            cursor.execute("""
                SELECT u.id as user_id, u.username, u.password, e.id as eleve_id, u.role
                FROM users u
                JOIN eleves e ON e.id = u.eleve_id
